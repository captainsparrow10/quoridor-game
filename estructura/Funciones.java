        ...
        try {
            ...
            switch (option) {
                ...
                case 1:
                    ...
                    // Validamos que el movimiento hacia esa dirrección esté dentro del rango del
                    // tablero.
                    ...
                    // Validacion en caso de que un peon esté encima de otro, no borrar el color
                    // actual al moverse el que esté debajo.
        ...
        try {
            ...
            switch (option) {
                ...
                case 1:
                    ...
                    if ((positionX < 0 || positionX > 16) || (positionY < 0 || positionY > 16)) {
                        JOptionPane.showMessageDialog(null, "La coordenada se sale del tablero.", "a",
                                JOptionPane.ERROR_MESSAGE);
                        return false;
                    }
                    ...
                    // Se le pregunta al usuario a que lado quiere extender el muro (Izquierda o
                    // derecha)
                    option = Integer.parseInt(JOptionPane
                            .showInputDialog(
